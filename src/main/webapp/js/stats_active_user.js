app.controller('statsActiveUser',
    ['$scope', '$http', '$location', '$cookieStore', 'echartsService', 'uiGridConstants', '$sessionStorage',
        function ($scope, $http, $location, $cookieStore, echartsService, uiGridConstants, $sessionStorage) {
            ...
            var statsActiveUserChart = echartsService.line('statsActiveUser', '活跃角色');
            ...
            $scope.activeUser = function () {
                ...
                var calSuccess = function (data, status, headers, config) {
                    ...
                    var legendDate = ['活跃角色数', '平均游戏时长', '平均游戏次数'];
                    var legendselect = {
                        '平均游戏时长': false,
                        '平均游戏次数': false
                    };
                    if (message.channelTag != null && dailyactive.length > 0) {
                        ...
                        for (var q = 0; q < le; q++) {
                            ...
                            for (var i = 0; i < dailyactive.length; i++) {
                                ...
                                if (dailyactive[i].channelTag == strs[q] || dailyactive[i] ==null || dailyactive[i] =="") {
                    ...
                    if (statsActiveUserChart == null)
                        statsActiveUserChart = echartsService.line('statsActiveUser', '新增角色');
                    //if (tagArr.length <= 1) {
                    ...
                    //}
                    //else {
                    //    if (statsActiveUserChart) {
                    //        statsActiveUserChart.dispose();
                    //        statsActiveUserChart = echartsService.line('statsActiveUser', '活跃角色');
                    //    }
                    //}
                    spinner.spin();
                };
