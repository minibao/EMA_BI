...
<div class="main-content span9 plantform-userpay-page" ng-controller="statsPlantformBigRRetain">
  <h1 class="text-center">大R总保留</h1>
  <hr>
...
<script src="${ctx}/js/pf/stats_plantform_big_r_retain.js"></script>
