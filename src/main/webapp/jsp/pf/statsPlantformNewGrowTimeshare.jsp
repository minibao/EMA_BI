...
<div class="main-content span9 plantform-active-page" ng-controller="statsPlantformNewGrowTimeshare">
  <h1 class="text-center">平台分时新增</h1>
  <hr>
...
<script src="${ctx}/js/pf/stats_plantform_newgrow_timeshare.js"></script>
