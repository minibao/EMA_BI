...
<div class="main-content span9 plantform-newgrow-page" ng-controller="statsPlantformNewGrow">
    ...
    <form class="form-inline">
        <%@ include file="/jsp/commons/_plantformselectors.jsp" %>
        ...
        <button type="button" class="btn btn-success" ng-click="hideGrid = !hideGrid">{{ hideGrid && '隐藏' || '显示' }}表格
        </button>
        ...
        <hr>
        <div ui-grid="gridOptions" ng-if="hideGrid" ui-grid-selection ui-grid-exporter ui-grid-grouping
    ...
    <form class="form-inline">
        ...
        <div class="text-center check-selector-btn">
            <button class="btn btn-small btn-success"
                    ng-click="compareSlc('gameDeviceCount');methodCompare = 'gameDeviceCount' ">游戏设备数
            </button>
            <button class="btn btn-small" ng-click="compareSlc('gameUidCount');methodCompare = 'gameUidCount' ">游戏账号数
            </button>
            <button class="btn btn-small" ng-click="compareSlc('pfDeviceCount');methodCompare = 'pfDeviceCount' ">
                平台设备数
            </button>
            <button class="btn btn-small" ng-click="compareSlc('pfUidCount');methodCompare = 'pfUidCount' ">平台账号数
            </button>
        </div>
        <hr>
...
<script src="${ctx}/js/pf/stats_plantform_new_grow.js"></script>
