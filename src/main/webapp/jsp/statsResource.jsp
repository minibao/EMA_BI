...
<%@ include file="/jsp/commons/_header.jsp"%> 
    ...
    <div class="main-content span9 " ng-controller="statsResource">
      <h1>资源统计</h1>
      <hr>               
      <form class="form-battle" id="">
        ...
        <div class="set-details">
          ...
          <span class="title-bar">资源种类:
            <select role="presentation" ng-options="item.dictName for item in category" ng-model="categoryType" class="select-picker" id="category"></select>
          </span>
...
<script src="${ctx}/js/stats_resource.js"></script>
