...
<div class="main-content span9 " ng-controller="statsResourceGold">
  ...
  <form class="form-battle" id="">
    ...
    <div class="set-details">
      <span class="creatdatetime">角色创建时间:<%@ include file="/jsp/commons/_daterangepicker.jsp"%></span>
      ...
      <hr />
          ...
          <span style="display: none;" class="title-bar">资源种类:
            <select role="presentation" ng-options="item.dictName for item in category" ng-model="categoryType" categoryid="99" category="金币"  class="select-picker" id="category"></select>
          </span>
...
<script>
  $(document).ready(function(){
    ...
    //初始化角色时间选择
    $('.creatdatetime .date-picker-star').addClass('date-hour');
    $('.creatdatetime .date-picker-end').addClass('date-hour');
